//require se asocia comúnmente con el sistema CommonJS, mientras que import funciona con el sistema de módulos ES6
//ES6 requiere configuración previa en packege.json //configuración hecha pero no fue requerida
//en nuestro caso utilizaremos sistema CommonJS
...
const {database} = require('./keys') //acceso a base de datos //configuración de credenciales

//initializations / inicializaciones
const app = express(); // Ejecución de frameworks express y guardamos en variable para ser usada a partir de ahora como por ej: "app.use...."
require('./lib/passport'); // metodos de gran ayuda en manejo de de la utentificación del usuario
...
app.set('view engine', '.hbs'); // configuracion para utilizar nuestro motor de plantillas Handlebars

// MIDDLEWARES
//funciones que se ejecutan cuando un usuario envia una peticion
app.use(session({
    secret: 'phoenix',
...
// GLOBALS VARIABLES
// Variables que se requieren desde varias secciones de mi aplicación /ej: Información del usuario
// middlewares global

// flash is not a function /revisar documentación /error solucionado /envio de mensajes
...
// URLS de nuestro servidor /Manejo de rutas
//-principales
...
//-para autentificación del usuario
app.use(require('./routes/authentication'));
// singin/logout/login

// manejo de ruta para traer información de productos de la tienda
app.use('/itemsTienda', require('./routes/itemsTienda'));

//PUBLIC 
// Archivos públicos:aquel código al que el navegador puede acceder /aqui se debe tener precaución en no mostrar código que comprometa la app
//En nuestro caso es de suma importancia reemplazar localstorage o session storage al lado del servidor proximamente
app.use(express.static(path.join(__dirname,'public')));

// STARTINGs the Server
//aqui se inician los puertos que utilizaremos para lanzar la app al navegador
